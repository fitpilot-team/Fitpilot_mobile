...
export interface MeasurementHistoryItem {
  ...
  relaxed_arm_midpoint_cm?: MeasurementValue;
  contracted_arm_midpoint_cm?: MeasurementValue;
  forearm_cm?: MeasurementValue;
  wrist_cm?: MeasurementValue;
  ...
  arm_left_cm?: MeasurementValue;
  arm_right_cm?: MeasurementValue;
  mid_thigh_cm?: MeasurementValue;
  calf_cm?: MeasurementValue;
  thigh_left_cm?: MeasurementValue;
  thigh_right_cm?: MeasurementValue;
...
export interface CreateOwnMeasurementPayload {
  ...
  cephalic_cm?: number;
  neck_cm?: number;
  relaxed_arm_midpoint_cm?: number;
  contracted_arm_midpoint_cm?: number;
  forearm_cm?: number;
  wrist_cm?: number;
