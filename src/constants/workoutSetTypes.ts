...
export const WORKOUT_SET_TYPE_DEFINITIONS: Record<WorkoutSetType, WorkoutSetTypeDefinition> = {
  ...
  rest_pause: {
    ...
    label: 'Rest-Pause',
    shortLabel: 'RP',
    description: 'Breves pausas para extender la serie con más repeticiones efectivas.',
  ...
  backoff: {
    ...
    label: 'Backoff Set',
    shortLabel: 'BACK',
    description: 'Serie de descarga con menos peso para sumar volumen después de la top set.',
  ...
  myo_reps: {
    ...
    label: 'Myo-Reps',
    shortLabel: 'MYO',
    description: 'Una serie activadora seguida de mini-series cortas con descansos mínimos.',
    captureHint: 'Registra la activación y después cada mini-serie como un segmento.',
    captureMode: 'dynamic',
    minimumSegments: 2,
  },
  cluster: {
    ...
    label: 'Cluster Set',
    shortLabel: 'CL',
    description: 'Micro-pausas intra-serie para sostener más repeticiones con carga alta.',
